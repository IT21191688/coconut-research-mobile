...
const CopraMoldDetectionView: React.FC = () => {
  ...
  const [moldResult, setMoldResult] = useState<{ class: string; confidence: number } | null>(null);
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.resourceButtonsContainer}>
          <View style={styles.resourceButtons}>
            <TouchableOpacity style={styles.resourceButton} onPress={handleImageCapture}>
              <View style={[styles.resourceIcon, { backgroundColor: colors.error + "15" }]}>
            ...
            <TouchableOpacity style={styles.resourceButton} onPress={handleImageUpload}>
              <View style={[styles.resourceIcon, { backgroundColor: colors.warning + "15" }]}>
        ...
        {imageUri && (
          <View style={styles.imageContainer}>
            ...
            <Text style={styles.imageHint}>Selected image ready for mold analysis</Text>
          </View>
        )}
        ...
        {moldResult && (
          <View style={[styles.resultContainer, 
            { backgroundColor: moldResult.class === 'Healthy' ? colors.success + '10' : colors.error + '10' }
          ]}>
            <Text style={styles.resultTitle}>Analysis Result</Text>
            <View style={styles.resultContent}>
              <View style={[styles.statusIndicator, 
                { backgroundColor: moldResult.class === 'Healthy' ? colors.success : colors.error }
              ]}>
                <Ionicons 
                  name={moldResult.class === 'Healthy' ? 'checkmark-circle' : 'warning'} 
                  size={32} 
                  color={colors.white} 
                />
              </View>
              <Text style={[styles.statusText, 
                { color: moldResult.class === 'Healthy' ? colors.success : colors.error }
              ]}>
                {moldResult.class}
              </Text>
