...
//               {index % 3 === 0 ? 'Active' : index % 3 === 1 ? 'Drying' : 'Complete'}
//             </Text>
//           </View>
//         </View>
...
//               <Text style={styles.infoHighlight}>{item.readingsCount}</Text> Readings
//             </Text>
//           </View>
...
//             <Text style={styles.infoText}>
//               Updated <Text style={styles.infoHighlight}>{getTimeSince(item.lastUpdated)}</Text>
//             </Text>
//           </View>
...
//       <Text style={styles.headerTitle}>Copra Batches</Text>
...
//       <Text style={styles.footerButtonText}>Create New Batch</Text>
//     </TouchableOpacity>
//   );
